...
def plot_history(training_history):
    ...
    plt.tight_layout()
    plt.savefig("/home/mia/drone-classification/figures/loss-history082801.png", dpi=200)
    ...
    plt.tight_layout()
    plt.savefig("/home/mia/drone-classification/figures/acc-history082801.png", dpi=200)
...
def cal_confusion_matrix(y_test, y_pred, f):
    ...
    lables = ['David_Tricopter','DJI_Matrice600_P' ,'Matrice200','Matrice200_V2','Mavic_Air2', 'Mavic_Mini1',
    ...
    # plt.show()
    plt.savefig('/home/mia/drone-classification/figures/cm082801.png', dpi=200)
...
if __name__ == "__main__":
    ...
    x, y = dataloader.load_dataset(
        dataset="Drone_Dataset/0828_23_classes", feature="mfcc"
    )
    ...
    f = open("/home/mia/drone-classification/08-28-23/run1.log", "w")
    ...
    for i in range(1, 11):
        ...
        sns.despine()
        # plt.show()
        plt.savefig('/home/mia/drone-classification/figures/roc082801.png', dpi=200)
